...
<template>
  <section class="text-base">
    <div class="text-center">
      <h5 class="text-h5 mb-4">Thank You! 😇</h5>
      <p>
        Your order
        <span class="font-weight-medium text-high-emphasis">#1536548131</span>
        has been placed!
      </p>
      <p class="mb-0">
        We sent an email to
      ...
      <div class="d-flex align-center gap-1 justify-center">
        <VIcon size="20" icon="mdi-clock-outline" />
    ...
    <VRow class="border rounded ma-0 mt-6">
      ...
      >
        <div class="d-flex align-center gap-2 text-high-emphasis mb-4">
          <VIcon icon="mdi-credit-card-outline" size="20" />
      ...
      <VCol cols="12" md="4" class="pa-5">
        <div class="d-flex align-center gap-2 text-high-emphasis mb-4">
          <VIcon icon="mdi-archive-outline" size="20" />
      ...
      <VCol cols="12" md="3">
        <div class="border rounded">
          <div class="border-b pa-5">
            ...
            <div
              class="d-flex align-center justify-space-between text-base mb-3"
            >
            ...
            <div class="d-flex align-center justify-space-between text-base">
              ...
              <div v-if="props.checkoutData.deliverySpeed === 'free'">
                <span class="text-decoration-line-through text-disabled me-2"
                  >$5.00</span
                >
                <VChip color="primary" density="comfortable" label>
                  Free
                </VChip>
              </div>
              <div v-else>
