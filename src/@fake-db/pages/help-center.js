        ...
        },
        {
          ...
          articles: [
            ...
            },
            {
              ...
              content: '<p>Counterfeit goods are goods, including digital goods, that are promoted, sold, or otherwise distributed using a trademark or brand that is identical to, or substantially indistinguishable from, the registered trademark or brand of another, without authorization from the trademark or brand user. Counterfeit goods attempt to deceive consumers into believing the counterfeit is a genuine product of the brand user, or to represent themselves as faux, replicas or imitations of the genuine product.</p><p>Counterfeit goods are goods, including digital goods, that are promoted, sold, or otherwise distributed using a trademark or brand that is identical to, or substantially indistinguishable from, the registered trademark or brand of another, without authorization from the trademark or brand user. Counterfeit goods attempt to deceive consumers into believing the counterfeit is a genuine product of the brand user, or to represent themselves as faux, replicas or imitations of the genuine product.</p>',
            },
            {
